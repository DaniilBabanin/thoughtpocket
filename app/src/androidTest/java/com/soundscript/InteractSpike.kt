 ...
 *   tools/run-scaletest.sh ; adb shell am instrument -e class com.soundscript.InteractSpike \
 *     -w com.soundscript.test/androidx.test.runner.AndroidJUnitRunner ; adb logcat -d -s INT
 */
class InteractSpike {
