 ...
 *   tools/run-scaletest.sh ; adb shell am instrument -e class com.thoughtpocket.ComplexQueryTest \
 *     -w com.thoughtpocket.test/androidx.test.runner.AndroidJUnitRunner ; adb logcat -d -s CQ
